...
local layouts = {
    ...
    awful.layout.suit.magnifier -- активное окно в центре, остальные сзади
}
-- }}}
...
-- {{{ Tags
-- Определение тегов, которые отобразятся на всех экранах
tags = {}
-- Массив имен рабочих столов
tag_names = {"Baba", "Nam", "Kevalam", "$", "&", "#"}
-- устанавливает каждому экрану настройку тегов
for s = 1, screen.count() do
